  ...
  <div>
    <section class="h-screen flex justify-center items-center text-center">
      <div class="container p-5">
        <img class="w-32 mx-auto mb-12 shadow-xl rounded-full u-photo" src="@/assets/images/profile.png" alt="A photo of Luke Bouch.">
        <h1 class="leading-10">Hello 👋<br>
        <span class="text-lg font-normal">my name is <a href="https://lukebouch.com" class="h-card p-name">Luke Bouch</a>.</span></h1>
      </div>
    </section>
